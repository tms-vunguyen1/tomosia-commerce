            ...
            {option.values.map((value) => {
              ...
              return (
                <div key={value}>
                  ...
                  >
                    {/* Render the color image for the current value. A value
                        with no matching image (the swatch map is keyed by
                        image altText) falls back to its label, the same way
                        every non-Color option renders. */}
                    {option.name === "Color" && imageMap[value] ? (
                      <div
                        key={value}
